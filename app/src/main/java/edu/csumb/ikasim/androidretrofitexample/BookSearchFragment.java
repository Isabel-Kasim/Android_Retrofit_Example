...
import edu.csumb.ikasim.androidretrofitexample.viewmodels.BookViewModel;
...
public class BookSearchFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getVolumesResponseLiveData().observe(this, new Observer<VolumeResponse>() {
            @Override
            public void onChanged(VolumeResponse volumesResponse) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.booksearch, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.booksearch_searchResultsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapter);

        keywordEditText = view.findViewById(R.id.booksearch_keyword);
        authorEditText = view.findViewById(R.id.booksearch_author);
        searchButton = view.findViewById(R.id.booksearch_search);
